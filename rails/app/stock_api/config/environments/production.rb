Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "liff_production"
  ...
  (ENV["RAILS_LOG_TO_STDOUT"].present? ? ActiveSupport::Logger.new(STDOUT) : ChronoLogger.new(config.paths['log'].first + '.%Y%m')).tap do |logger|
